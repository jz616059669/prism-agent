...
@click.version_option(version="2.1.7", prog_name="PRISM")
@click.pass_context
def cli(ctx):
    """
    ...
    if ctx.invoked_subcommand is None:
        ...
        try:
            ...
            console.print(Panel.fit(
                f"[bold cyan]PRISM Agent[/bold cyan] [dim]v2.1.7[/dim]\n"
            ...
            console.print(Panel.fit(
                "[bold cyan]PRISM Agent[/bold cyan] [dim]v2.1.7[/dim]\n"
...
def version():
    """显示版本信息"""
    console.print("PRISM Agent v2.1.7")
...
from prism.cli.conditions import conditions  # noqa: E402
