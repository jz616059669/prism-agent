...
class PrismDesktop:
    ...
    def _build_sidebar(self) -> ft.Container:
        ...
        browser_open_btn = ft.Button("打开网页", icon=ft.Icons.LANGUAGE_ROUNDED, width=280, style=ft.ButtonStyle(shape=ft.RoundedRectangleBorder(radius=12), padding=ft.Padding(14, 10, 14, 10), bgcolor=ft.Colors.SURFACE_CONTAINER,
                    shadow=ft.BoxShadow(blur_radius=6, color=ft.Colors.with_opacity(0.06, ft.Colors.BLACK), spread_radius=0, offset=ft.Offset(0, 1)), color=ft.Colors.ON_SURFACE), animate_scale=ft.Animation(180, ft.AnimationCurve.EASE_IN_OUT))
        ...
        self._session_empty_state = ft.Container(
            ...
            padding=ft.Padding(36, 36, 36, 36),
            border_radius=12,
        ...
        sidebar_content.controls.extend([
            ft.Container(
                content=ft.Column([
                    ...
                    shadow=ft.BoxShadow(blur_radius=6, color=ft.Colors.with_opacity(0.06, ft.Colors.BLACK), spread_radius=0, offset=ft.Offset(0, 1)), color=ft.Colors.ON_SURFACE), on_click=lambda e: self._open_preset_manager()),
                    ], spacing=8, tight=True),
                ], tight=True, spacing=6),
                bgcolor=ft.Colors.SURFACE_CONTAINER,
                    shadow=ft.BoxShadow(blur_radius=6, color=ft.Colors.with_opacity(0.06, ft.Colors.BLACK), spread_radius=0, offset=ft.Offset(0, 1)),
                border_radius=26,
                padding=12,
    ...
    def _build_right_panel(self) -> ft.Column:
        ...
        terminal_tab = ft.Column(
            [
                ...
                ft.Container(self.terminal_list, expand=True, border=ft.Border.all(1, ft.Colors.OUTLINE_VARIANT), border_radius=26, padding=ft.Padding(12, 8, 12, 8), bgcolor=ft.Colors.SURFACE, shadow=ft.BoxShadow(blur_radius=4, color=ft.Colors.with_opacity(0.04, ft.Colors.BLACK), spread_radius=0, offset=ft.Offset(0, 1))),
            ],
            expand=True,
            spacing=8,
        )
        mcp_tab = ft.Column(
            [
                ...
                ft.Container(self.mcp_list, expand=True, border=ft.Border.all(1, ft.Colors.OUTLINE_VARIANT), border_radius=26, padding=ft.Padding(12, 8, 12, 8), bgcolor=ft.Colors.SURFACE, shadow=ft.BoxShadow(blur_radius=4, color=ft.Colors.with_opacity(0.04, ft.Colors.BLACK), spread_radius=0, offset=ft.Offset(0, 1))),
            ],
            expand=True,
            spacing=8,
        )
    ...
    def _append(self, role: str, text: str, retry: bool = False, retry_text: str = "", placeholder: bool = False):
        ...
        if is_user:
            ...
            bubble = ft.Container(
                ...
                border_radius=26,
                padding=ft.Padding(16, 14, 16, 14),
                shadow=ft.BoxShadow(blur_radius=10, color=ft.Colors.with_opacity(0.18, ft.Colors.BLACK), spread_radius=0, offset=ft.Offset(0, 2)),
            ...
            bubble = ft.Container(
                ...
                border_radius=26,
                padding=ft.Padding(16, 14, 16, 14),
                shadow=ft.BoxShadow(blur_radius=8, color=ft.Colors.with_opacity(0.15, ft.Colors.BLACK), spread_radius=0, offset=ft.Offset(0, 1)),
                animate=ft.Animation(200, ft.AnimationCurve.EASE_IN_OUT),
            )
    ...
    def _rename_session(self, name: str):
        ...
        rename_field = ft.TextField(value=name, label="新会话名称", border_radius=26, autofocus=True)
