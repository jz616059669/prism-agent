    ...
    def _build_right_panel(self) -> ft.Column:
        ...
        terminal_tab = ft.Column(
            [
                ...
                ft.Container(self.terminal_list, expand=True, border=ft.Border.all(1, ft.Colors.OUTLINE_VARIANT), border_radius=34, padding=ft.Padding(16, 12, 16, 12), bgcolor=ft.Colors.SURFACE, shadow=ft.BoxShadow(blur_radius=8, color=ft.Colors.with_opacity(0.08, ft.Colors.BLACK), spread_radius=0, offset=ft.Offset(0, 1))),
            ],
            expand=True,
            spacing=8,
        )
        mcp_tab = ft.Column(
            [
                ...
                ft.Container(self.mcp_list, expand=True, border=ft.Border.all(1, ft.Colors.OUTLINE_VARIANT), border_radius=34, padding=ft.Padding(16, 12, 16, 12), bgcolor=ft.Colors.SURFACE, shadow=ft.BoxShadow(blur_radius=8, color=ft.Colors.with_opacity(0.08, ft.Colors.BLACK), spread_radius=0, offset=ft.Offset(0, 1))),
            ],
            expand=True,
            spacing=8,
        )
